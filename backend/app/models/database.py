        ...
        "questions": [
            {"id": 1, "text": "Qual a capital do Brasil?", "type": "single_choice", "required": True,
             "options": [
                 ...
                 {"id": 3, "text": "Brasília", "is_correct": True}, {"id": 4, "text": "Salvador"},
             ]},
            {"id": 2, "text": "Quais destes são linguagens de programação? (marque todos)", "type": "multiple_choice", "required": True,
             "options": [
                 {"id": 1, "text": "Python", "is_correct": True}, {"id": 2, "text": "HTML"},
                 {"id": 3, "text": "JavaScript", "is_correct": True}, {"id": 4, "text": "CSS"},
                 {"id": 5, "text": "Cobra"},
             ]},
    ...
    },
    {
        ...
        "questions": [
            {"id": 1, "text": "Qual empresa desenvolveu o sistema operacional Android?", "type": "single_choice", "required": True,
             "options": [
                 {"id": 1, "text": "Apple"}, {"id": 2, "text": "Google", "is_correct": True},
            ...
            {"id": 2, "text": "Quais destas são linguagens compiladas? (marque todas)", "type": "multiple_choice", "required": True,
             "options": [
                 {"id": 1, "text": "C", "is_correct": True}, {"id": 2, "text": "Rust", "is_correct": True},
                 {"id": 3, "text": "Python"}, {"id": 4, "text": "Java", "is_correct": True},
                 {"id": 5, "text": "Go", "is_correct": True}, {"id": 6, "text": "JavaScript"},
             ]},
            {"id": 3, "text": "O que significa a sigla API?", "type": "single_choice", "required": True,
             "options": [
                 {"id": 1, "text": "Application Programming Interface", "is_correct": True}, {"id": 2, "text": "Automated Program Integration"},
            ...
            {"id": 5, "text": "Qual banco de dados é conhecido por ser relacional?", "type": "single_choice", "required": True,
             "options": [
                 {"id": 1, "text": "MongoDB"}, {"id": 2, "text": "PostgreSQL", "is_correct": True},
            ...
            {"id": 6, "text": "Quais destes são protocolos de comunicação web? (marque todos)", "type": "multiple_choice", "required": True,
             "options": [
                 {"id": 1, "text": "HTTP", "is_correct": True}, {"id": 2, "text": "FTP", "is_correct": True},
                 {"id": 3, "text": "SQL"}, {"id": 4, "text": "WebSocket", "is_correct": True},
                 {"id": 5, "text": "SMTP", "is_correct": True}, {"id": 6, "text": "JSON"},
             ]},
        ],
    },
]
...
def seed_quizzes(db):
    ...
    seed_titles = {s["title"] for s in SEED_QUIZZES}
    existing = {q.title: q for q in db.query(QuizDB).filter(QuizDB.user_id.is_(None)).all()}
    seeded = 0
    updated = 0
    for data in SEED_QUIZZES:
        quiz = existing.get(data["title"])
        if quiz:
            if quiz.description != data.get("description", "") or quiz.questions != data["questions"]:
            ...
            db.add(QuizDB(**data))
            seeded += 1
    orphaned = [q for t, q in existing.items() if t not in seed_titles]
    for q in orphaned:
        db.delete(q)
    db.commit()
    if orphaned:
        logger.info("Seed: %d quizzes órfãos removidos", len(orphaned))
    logger.info("Seed: %d inseridos, %d atualizados, %d existentes inalterados", seeded, updated, len(existing) - updated - len(orphaned))
